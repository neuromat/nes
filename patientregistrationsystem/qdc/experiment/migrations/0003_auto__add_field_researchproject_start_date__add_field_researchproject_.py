...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchProject.start_date'
        db.add_column(u'experiment_researchproject', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 2, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'ResearchProject.end_date'
        db.add_column(u'experiment_researchproject', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchProject.start_date'
        db.delete_column(u'experiment_researchproject', 'start_date')

        # Deleting field 'ResearchProject.end_date'
        db.delete_column(u'experiment_researchproject', 'end_date')
