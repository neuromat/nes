...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Group.instruction'
        db.delete_column(u'experiment_group', 'instruction')


    def backwards(self, orm):
        # Adding field 'Group.instruction'
        db.add_column(u'experiment_group', 'instruction',
