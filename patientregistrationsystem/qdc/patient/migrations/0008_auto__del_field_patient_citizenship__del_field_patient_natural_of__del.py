...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Patient.citizenship'
        db.delete_column(u'patient_patient', 'citizenship')

        # Deleting field 'Patient.natural_of'
        db.delete_column(u'patient_patient', 'natural_of')

        # We don't want to loose information about changes made in these fields when migrating from the old version to
        # an new one.

        # # Deleting field 'HistoricalPatient.citizenship'
        # db.delete_column(u'patient_historicalpatient', 'citizenship')
        #
        # # Deleting field 'HistoricalPatient.natural_of'
        # db.delete_column(u'patient_historicalpatient', 'natural_of')


    def backwards(self, orm):
        # Adding field 'Patient.citizenship'
        db.add_column(u'patient_patient', 'citizenship',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Patient.natural_of'
        db.add_column(u'patient_patient', 'natural_of',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # As these columns were not deleted, there is no need to add them.

        # # Adding field 'HistoricalPatient.citizenship'
        # db.add_column(u'patient_historicalpatient', 'citizenship',
        #               self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
        #               keep_default=False)
        #
        # # Adding field 'HistoricalPatient.natural_of'
        # db.add_column(u'patient_historicalpatient', 'natural_of',
        #               self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
        #               keep_default=False)
