...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.experimental_protocol'
        db.alter_column(u'experiment_group', 'experimental_protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.Component'], null=True))

    def backwards(self, orm):

        # Changing field 'Group.experimental_protocol'
        db.alter_column(u'experiment_group', 'experimental_protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.ComponentConfiguration'], null=True))
