...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Patient.origin'
        db.add_column(u'patient_patient', 'origin',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalPatient.origin'
        db.add_column(u'patient_historicalpatient', 'origin',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Patient.origin'
        db.delete_column(u'patient_patient', 'origin')

        # Deleting field 'HistoricalPatient.origin'
        db.delete_column(u'patient_historicalpatient', 'origin')
