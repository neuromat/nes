...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'experiment_keyword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'experiment', ['Keyword'])

        # Adding M2M table for field keywords on 'ResearchProject'
        m2m_table_name = db.shorten_name(u'experiment_researchproject_keywords')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('researchproject', models.ForeignKey(orm[u'experiment.researchproject'], null=False)),
            ('keyword', models.ForeignKey(orm[u'experiment.keyword'], null=False))
        ))
        db.create_unique(m2m_table_name, ['researchproject_id', 'keyword_id'])


    def backwards(self, orm):
        # Deleting model 'Keyword'
        db.delete_table(u'experiment_keyword')

        # Removing M2M table for field keywords on 'ResearchProject'
        db.delete_table(db.shorten_name(u'experiment_researchproject_keywords'))
