...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'patient_questionnaireresponse', (
        ...
        db.send_create_signal(u'patient', ['QuestionnaireResponse'])


    def backwards(self, orm):
        # Deleting model 'QuestionnaireResponse'
        db.delete_table(u'patient_questionnaireresponse')
    ...
    models = {
        ...
        u'patient.questionnaireresponse': {
