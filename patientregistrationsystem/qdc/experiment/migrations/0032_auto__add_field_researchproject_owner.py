...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchProject.owner'
        db.add_column(u'experiment_researchproject', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchProject.owner'
        db.delete_column(u'experiment_researchproject', 'owner_id')
