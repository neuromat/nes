# coding=utf-8
from django.forms import ModelForm, TextInput, DateInput, Select, RadioSelect, PasswordInput, \
...
class PatientForm(ModelForm):
    class Meta:
        ...
        fields = [
            'cpf_id', 'name_txt', 'number_record', 'rg_id', 'medical_record_number',
            'natural_of_txt',
            'citizenship_txt', 'street_txt', 'zipcode_number', 'country_txt', 'state_txt',
            'city_txt', 'phone_number',
            'cellphone_number', 'email_txt', 'date_birth_txt', 'gender_opt', 'marital_status_opt',
        ]

        widgets = {
            'name_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar nome completo',
            ...
            'cpf_id': TextInput(attrs={'class': 'form-control', 'placeholder': 'Entrar CPF',
                                       'id': "cpf_id"}),
            'rg_id': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar RG', 'id': "rg_id"}),
            'natural_of_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar Naturalidade',
                       'id': "naturalOf"}),
            'street_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Rua - Complemento',
                       'id': "street_txt"}),
            ...
            'city_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar cidade', 'id': "city"}),
            'phone_number': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar telefone para contato',
                       'id': "phone"}),
            'cellphone_number': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar celular',
                       'id': "cellphone"}),
            ...
            'medical_record_number': TextInput(attrs={'class': 'form-control',
                                                      ...
                                                      'id': "records_number"}),
            'citizenship_txt': SelectBoxCountries(
                attrs={'id': 'id_chosen_country', 'data-flags': 'true'}),
            'country_txt': SelectBoxCountries(
                attrs={'id': 'id_country_state_address', 'data-flags': 'true'}),
            'state_txt': SelectBoxState(
                attrs={'data-country': 'id_country_state_address', 'id': 'id_chosen_state'}),
...
class SocialDemographicDataForm(ModelForm):
    class Meta:
        ...
        fields = ['profession_txt', 'occupation_txt', 'tv_opt', 'dvd_opt', 'radio_opt', 'bath_opt',
                  'automobile_opt', 'wash_machine_opt', 'refrigerator_opt', 'freezer_opt',
                  'house_maid_opt',
                  'religion_opt', 'payment_opt', 'flesh_tone_opt', 'schooling_opt',
                  'benefit_government_bool',
                  'social_class_opt']
        widgets = {
            'benefit_government_bool': RadioSelect(attrs={'id': 'id_benefit'},
                                                   choices=(('1', 'Sim'), ('0', 'Não'))),
            ...
            'profession_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar profissão',
                       'id': "profession"}),
            'occupation_txt': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar ocupação',
                       'id': "occupation"}),
            ...
            'freezer_opt': RadioSelect(attrs={'id': 'id_freezer_opt'},
                                       choices=(
                                       (0, '0'), (1, '1'), (2, '2'), (3, '3'), (4, '4 ou +'))),
            'social_class_opt': TextInput(
                attrs={'class': 'form-control', 'id': "social_class_opt", 'disabled': "True"})
        }
...
class SocialHistoryDataForm(ModelForm):
    class Meta:
        ...
        fields = ['smoker', 'amount_cigarettes_opt', 'ex_smoker', 'alcoholic',
                  'alcohol_frequency_opt',
                  'alcohol_period_opt', 'drugs_opt', ]

        widgets = {
            'smoker': RadioSelect(attrs={'id': 'id_smoker'}, choices=(('1', 'Sim'), ('0', 'Não'))),
            'amount_cigarettes_opt': Select(
                attrs={'class': 'form-control', 'id': 'id_amount_cigarettes'}),
            'ex_smoker': RadioSelect(attrs={'id': 'id_ex_smoker'},
                                     choices=(('1', 'Sim'), ('0', 'Não'))),
            'alcoholic': RadioSelect(attrs={'id': 'id_alcoholic'},
                                     choices=(('1', 'Sim'), ('0', 'Não'))),
...
class MedicalRecordForm(ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'cervical_vertebrae_fracture', 'thoracic_vertebrae_fracture',
            'lumbosacral_vertebrae_fracture',
            'superior_members_fracture_side', 'inferior_members_fracture_side',
            'pelvis_fracture_side',
            'orthopedic_surgery', 'scapula_surgery_side', 'clavicle_surgery_side', 'rib_surgery',
            'cervical_vertebrae_surgery', 'thoracic_vertebrae_surgery',
            'lumbosacral_vertebrae_surgery',
            'superior_members_surgery_side', 'inferior_members_surgery_side', 'pelvis_surgery_side',
            'nerve_surgery', 'nerve_surgery_type', 'vertigo_history', 'pain_localizations',
            'headache',
        ...
        widgets = {
            ...
            'fracture_history': RadioSelect(attrs={'id': 'fracture_history'},
                                            choices=(('1', 'Sim'), ('0', 'Não'))),
            'scapula_fracture_side': Select(
                attrs={'class': 'form-control', 'id': 'scapula_fracture_side'}),
            'clavicle_fracture_side': Select(
                attrs={'class': 'form-control', 'id': 'clavicle_fracture_side'}),
            'rib_fracture': RadioSelect(attrs={'id': 'rib_fracture'},
                                        choices=(('1', 'Sim'), ('0', 'Não'))),
            'cervical_vertebrae_fracture': CheckboxSelectMultiple(
                attrs={'id': 'cervical_vertebrae_fracture'}),
            'thoracic_vertebrae_fracture': CheckboxSelectMultiple(
                attrs={'id': 'thoracic_vertebrae_fracture'}),
            'lumbosacral_vertebrae_fracture': CheckboxSelectMultiple(
                attrs={'id': 'lumbosacral_vertebrae_fracture'}),
            ...
            'pelvis_fracture_side': Select(
                attrs={'class': 'form-control', 'id': 'pelvis_fracture_side'}),
            'orthopedic_surgery': RadioSelect(attrs={'id': 'orthopedic_surgery'},
                                              choices=(('1', 'Sim'), ('0', 'Não'))),
            'scapula_surgery_side': Select(
                attrs={'class': 'form-control', 'id': 'scapula_surgery_side'}),
            'clavicle_surgery_side': Select(
                attrs={'class': 'form-control', 'id': 'clavicle_surgery_side'}),
            'rib_surgery': RadioSelect(attrs={'id': 'rib_surgery'},
                                       choices=(('1', 'Sim'), ('0', 'Não'))),
            ...
            'thoracic_vertebrae_surgery': RadioSelect(attrs={'id': 'thoracic_vertebrae_surgery'},
                                                      choices=(('1', 'Sim'), ('0', 'Não'))),
            'lumbosacral_vertebrae_surgery': RadioSelect(
                attrs={'id': 'lumbosacral_vertebrae_surgery'},
                choices=(('1', 'Sim'), ('0', 'Não'))),
            ...
            'pelvis_surgery_side': Select(
                attrs={'class': 'form-control', 'id': 'pelvis_surgery_side'}),
            'nerve_surgery': RadioSelect(attrs={'id': 'nerve_surgery'},
                                         choices=(('1', 'Sim'), ('0', 'Não'))),
            'nerve_surgery_type': TextInput(attrs={'class': 'form-control',
                                                   'placeholder': 'Entrar tipo de cirurgia de nervo'}),
            'vertigo_history': RadioSelect(attrs={'id': 'vertigo_history'},
                                           choices=(('1', 'Sim'), ('0', 'Não'))),
            ...
            'hypertension': RadioSelect(attrs={'id': 'hypertension'},
                                        choices=(('1', 'Sim'), ('0', 'Não'))),
...
class UserForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'first_name': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar primeiro nome'}),
            'last_name': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar último nome'}),
            'username': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar nome de usuário'}),
            ...
            'email': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Entrar e-mail', 'id': "email",
                       'type': 'email', 'data-error': "E-mail inválido",
    ...
    def clean_email(self):
        ...
        if email and User.objects.filter(email=email, is_active=True).exclude(
...
class UserFormUpdate(UserForm):
    password = CharField(required=False,
                         widget=PasswordInput(
                             attrs={'class': 'form-control', 'placeholder': 'Entrar senha',
    ...
    class Meta:
        ...
        widgets = {
            ...
            'description': Textarea(
                attrs={'class': 'form-control', 'placeholder': 'Descrição', 'cols': '100'}),
            ...
            'exam_site': TextInput(
                attrs={'class': 'form-control', 'placeholder': 'Local de realização'}),
        }
