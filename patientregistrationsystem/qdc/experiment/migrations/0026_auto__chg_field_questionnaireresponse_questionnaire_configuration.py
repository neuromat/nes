...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionnaireResponse.questionnaire_configuration'
        db.alter_column(u'experiment_questionnaireresponse', 'questionnaire_configuration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.QuestionnaireConfiguration'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'QuestionnaireResponse.questionnaire_configuration'
        db.alter_column(u'experiment_questionnaireresponse', 'questionnaire_configuration_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiment.QuestionnaireConfiguration'], on_delete=models.PROTECT))
