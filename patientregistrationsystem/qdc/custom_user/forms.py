...
class UserForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'password': PasswordInput(attrs={'id': 'id_new_password1', 'class': 'form-control', 'placeholder': 'Entrar senha',
...
class UserFormUpdate(UserForm):
    password = CharField(required=False,
                         widget=PasswordInput(attrs={'id': 'id_new_password1', 'class': 'form-control', 'placeholder': 'Entrar senha',
                                                     'onkeyup': "passwordForce(); if(beginCheckPassword1)checkPass();"}))
