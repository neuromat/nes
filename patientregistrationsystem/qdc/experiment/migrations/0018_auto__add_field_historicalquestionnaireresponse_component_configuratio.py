...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalQuestionnaireResponse.component_configuration_id'
        db.add_column(u'experiment_historicalquestionnaireresponse', 'component_configuration_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionnaireResponse.component_configuration'
        db.add_column(u'experiment_questionnaireresponse', 'component_configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.ComponentConfiguration'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalQuestionnaireResponse.component_configuration_id'
        db.delete_column(u'experiment_historicalquestionnaireresponse', 'component_configuration_id')

        # Deleting field 'QuestionnaireResponse.component_configuration'
        db.delete_column(u'experiment_questionnaireresponse', 'component_configuration_id')
