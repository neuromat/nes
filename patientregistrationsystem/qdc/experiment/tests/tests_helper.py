...
from experiment.models import ResearchProject, Experiment, ExperimentResearcher, Publication, ContextTree, EEGSetting, \
    EEGAmplifierSetting, EMGSetting, TMSSetting, TMSDevice, EMGElectrodeSetting, EMGElectrodePlacementSetting, \
    StandardizationSystem, Muscle, MuscleSubdivision, MuscleSide, EMGElectrodePlacement, Component, \
    TaskForTheExperimenter, DigitalGamePhase, GenericDataCollection, EEG, EMG, TMS, Group, Subject, SubjectOfGroup, \
    Block, Manufacturer, Amplifier, EEGSolution, FilterType, Tag, ElectrodeModel, EEGElectrodeNet, \
    EEGElectrodeNetSystem, EEGElectrodeLocalizationSystem, EEGElectrodePosition, EEGElectrodeLayoutSetting, \
    EEGElectrodePositionSetting, EEGElectrodePositionCollectionStatus, Software, SoftwareVersion, ADConverter, Material, \
    EEGElectrodeCap, EEGCapSize, CoilModel, CoilShape, ComponentConfiguration, DataConfigurationTree, \
    QuestionnaireResponse, InformationType, FileFormat, GenericDataCollectionData, GenericDataCollectionFile, EEGData, \
    EEGFile, EMGData, DirectionOfTheInducedCurrent, CoilOrientation, TMSData, BrainAreaSystem, BrainArea, \
