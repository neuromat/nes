    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=models.CASCADE, to='patient.ClassificationOfDiseases',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification_of_diseases', models.ForeignKey(on_delete=models.CASCADE, to='patient.ClassificationOfDiseases')),
            ],
        ),
        migrations.CreateModel(
            name='ExamFile',
            fields=[
                ...
                ('exam', models.ForeignKey(on_delete=models.CASCADE, to='patient.ComplementaryExam')),
            ],
        ),
        migrations.CreateModel(
            name='FleshTone',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, null=True, max_length=254)),
                ('removed', models.BooleanField(default=False)),
                ('changed_by', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('gender', models.ForeignKey(on_delete=models.CASCADE, to='patient.Gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questionnaire_responsible', models.ForeignKey(on_delete=models.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_class', models.CharField(blank=True, null=True, max_length=10)),
                ('changed_by', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('flesh_tone', models.ForeignKey(on_delete=models.CASCADE, to='patient.FleshTone', blank=True, null=True)),
                ('patient', models.ForeignKey(on_delete=models.CASCADE, to='patient.Patient')),
                ('patient_schooling', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Schooling of the patient',
                                                        to='patient.Schooling', blank=True,
                                                        related_name='patient_schooling_set', null=True)),
                ('payment', models.ForeignKey(on_delete=models.CASCADE, to='patient.Payment', blank=True, null=True)),
                ('religion', models.ForeignKey(on_delete=models.CASCADE, to='patient.Religion', blank=True, null=True)),
                ('schooling', models.ForeignKey(on_delete=models.CASCADE, verbose_name='Schooling of the householder', to='patient.Schooling',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcoholic', models.BooleanField(null=True)),
                ('drugs', models.CharField(blank=True, null=True, max_length=25)),
                ('alcohol_frequency', models.ForeignKey(on_delete=models.CASCADE, to='patient.AlcoholFrequency', default=0, blank=True,
                                                        null=True)),
                ('alcohol_period', models.ForeignKey(on_delete=models.CASCADE, to='patient.AlcoholPeriod', default=0, blank=True, null=True)),
                ('amount_cigarettes', models.ForeignKey(on_delete=models.CASCADE, to='patient.AmountCigarettes', default=0, blank=True,
                                                        null=True)),
                ('changed_by', models.ForeignKey(on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('patient', models.ForeignKey(on_delete=models.CASCADE, to='patient.Patient')),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=models.CASCADE, to='patient.MedicalRecordData'),
        ),
        migrations.AddField(
