...
def search_patients_ajax(request):
    ...
    return render(request, 'patient/ajax_search.html', {'patients': patient_list})
...
def patients_verify_homonym(request):
    ...
    return render(request, 'patient/ajax_homonym.html', {'patient_homonym': patient_homonym})
...
def patients_verify_homonym_excluded(request):
    ...
    return render(request, 'patient/ajax_homonym.html', {'patient_homonym_excluded': patient_homonym_excluded})
