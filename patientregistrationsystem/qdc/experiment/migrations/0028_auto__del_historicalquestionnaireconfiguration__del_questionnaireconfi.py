...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HistoricalQuestionnaireResponse.questionnaire_configuration_id'
        db.delete_column(u'experiment_historicalquestionnaireresponse', 'questionnaire_configuration_id')

        # Deleting field 'QuestionnaireResponse.questionnaire_configuration'
        db.delete_column(u'experiment_questionnaireresponse', 'questionnaire_configuration_id')


        # Changing field 'QuestionnaireResponse.component_configuration'
        db.alter_column(u'experiment_questionnaireresponse', 'component_configuration_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiment.ComponentConfiguration'], on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'experiment_historicalquestionnaireconfiguration', (
            ...
            ('interval_between_fills_unit', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            (u'history_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('group_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True)),
        ...
        # Adding field 'HistoricalQuestionnaireResponse.questionnaire_configuration_id'
        db.add_column(u'experiment_historicalquestionnaireresponse', 'questionnaire_configuration_id',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'QuestionnaireResponse.questionnaire_configuration'
        db.add_column(u'experiment_questionnaireresponse', 'questionnaire_configuration',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.QuestionnaireConfiguration'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


        # Changing field 'QuestionnaireResponse.component_configuration'
        db.alter_column(u'experiment_questionnaireresponse', 'component_configuration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.ComponentConfiguration'], null=True, on_delete=models.PROTECT))
