    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coil_design', models.CharField(max_length=50,
                                                 choices=[('air_core_coil', 'Air core coil'),
        ...
        migrations.CreateModel(
            name='TMS',
            fields=[
                ('component_ptr', models.OneToOneField(auto_created=True, to='experiment.Component', primary_key=True,
        ...
        migrations.CreateModel(
            name='TMSDevice',
            fields=[
                ('equipment_ptr', models.OneToOneField(auto_created=True, to='experiment.Equipment', primary_key=True,
                                                       parent_link=True, serialize=False)),
                ('pulse_type', models.CharField(max_length=50,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('tms_setting', models.OneToOneField(related_name='tms_device_setting', serialize=False,
                                                     to='experiment.TMSSetting', primary_key=True)),
                ('pulse_stimulus_type', models.CharField(max_length=50,
                                                         choices=[('single_pulse', 'Single pulse'),
