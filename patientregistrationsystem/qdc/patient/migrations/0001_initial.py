    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(to='patient.ClassificationOfDiseases', related_name='children', null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(blank=True, max_length=15, db_index=True, validators=[patient.models.validate_cpf], null=True)),
                ...
                ('changed_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('gender', models.ForeignKey(to='patient.Gender', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(max_length=1, choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')])),
                ('changed_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('flesh_tone', models.ForeignKey(to='patient.FleshTone', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('history_user', models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='+', null=True, on_delete=django.db.models.deletion.SET_NULL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_date', models.DateTimeField()),
                ('history_type', models.CharField(max_length=1, choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')])),
                ('alcohol_frequency', models.ForeignKey(to='patient.AlcoholFrequency', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('alcohol_period', models.ForeignKey(to='patient.AlcoholPeriod', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('amount_cigarettes', models.ForeignKey(to='patient.AmountCigarettes', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('changed_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING)),
                ('history_user', models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='+', null=True, on_delete=django.db.models.deletion.SET_NULL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, max_length=15, choices=[('MO', 'Cell phone'), ('HO', 'Home phone'), ('WO', 'Business'), ('MA', 'Main'), ('FW', 'Business fax'), ('FH', 'Home fax'), ('PA', 'Pager'), ('OT', 'Other')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, null=True, max_length=50)),
                ('cpf', models.CharField(blank=True, max_length=15, unique=True, validators=[patient.models.validate_cpf], null=True)),
                ('origin', models.CharField(blank=True, null=True, max_length=50)),
                ('medical_record', models.CharField(blank=True, null=True, max_length=25)),
                ('date_birth', models.DateField(validators=[patient.models.validate_date_birth])),
                ('rg', models.CharField(blank=True, null=True, max_length=15)),
                ...
                ('marital_status', models.ForeignKey(to='patient.MaritalStatus', blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_class', models.CharField(blank=True, null=True, max_length=10)),
                ('changed_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('flesh_tone', models.ForeignKey(to='patient.FleshTone', blank=True, null=True)),
                ('patient', models.ForeignKey(to='patient.Patient')),
                ('patient_schooling', models.ForeignKey(verbose_name='Schooling of the patient', to='patient.Schooling', blank=True, related_name='patient_schooling_set', null=True)),
                ('payment', models.ForeignKey(to='patient.Payment', blank=True, null=True)),
                ('religion', models.ForeignKey(to='patient.Religion', blank=True, null=True)),
                ('schooling', models.ForeignKey(verbose_name='Schooling of the householder', to='patient.Schooling', blank=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alcoholic', models.NullBooleanField()),
                ('drugs', models.CharField(blank=True, null=True, max_length=25)),
                ('alcohol_frequency', models.ForeignKey(to='patient.AlcoholFrequency', default=0, blank=True, null=True)),
                ('alcohol_period', models.ForeignKey(to='patient.AlcoholPeriod', default=0, blank=True, null=True)),
                ('amount_cigarettes', models.ForeignKey(to='patient.AmountCigarettes', default=0, blank=True, null=True)),
                ('changed_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('patient', models.ForeignKey(to='patient.Patient')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='patient',
            field=models.ForeignKey(to='patient.Patient', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='patient.Schooling', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ),
        migrations.AddField(
            model_name='historicalsocialdemographicdata',
            name='payment',
            field=models.ForeignKey(to='patient.Payment', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ),
        migrations.AddField(
            model_name='historicalsocialdemographicdata',
            name='religion',
            field=models.ForeignKey(to='patient.Religion', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ),
        migrations.AddField(
            model_name='historicalsocialdemographicdata',
            name='schooling',
        ...
        migrations.AddField(
            ...
            name='marital_status',
            field=models.ForeignKey(to='patient.MaritalStatus', db_constraint=False, blank=True, related_name='+', null=True, on_delete=django.db.models.deletion.DO_NOTHING),
        ),
        migrations.AddField(
