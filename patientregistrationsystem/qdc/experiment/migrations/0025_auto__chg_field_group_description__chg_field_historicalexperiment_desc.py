...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'experiment_group', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'HistoricalExperiment.description'
        db.alter_column(u'experiment_historicalexperiment', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'HistoricalExperiment.title'
        db.alter_column(u'experiment_historicalexperiment', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'ResearchProject.description'
        db.alter_column(u'experiment_researchproject', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Component.description'
        db.alter_column(u'experiment_component', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Experiment.title'
        db.alter_column(u'experiment_experiment', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Experiment.description'
        db.alter_column(u'experiment_experiment', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Group.description'
        db.alter_column(u'experiment_group', 'description', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'HistoricalExperiment.description'
        db.alter_column(u'experiment_historicalexperiment', 'description', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'HistoricalExperiment.title'
        db.alter_column(u'experiment_historicalexperiment', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'ResearchProject.description'
        db.alter_column(u'experiment_researchproject', 'description', self.gf('django.db.models.fields.CharField')(max_length=1500))

        # Changing field 'Component.description'
        db.alter_column(u'experiment_component', 'description', self.gf('django.db.models.fields.CharField')(max_length=1500, null=True))

        # Changing field 'Experiment.title'
        db.alter_column(u'experiment_experiment', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Experiment.description'
        db.alter_column(u'experiment_experiment', 'description', self.gf('django.db.models.fields.CharField')(max_length=150))
