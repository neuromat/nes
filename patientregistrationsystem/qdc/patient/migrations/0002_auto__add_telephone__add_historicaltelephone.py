...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'patient_telephone', (
            ...
            ('note', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'patient', ['Telephone'])

        # Adding model 'HistoricalTelephone'
        db.create_table(u'patient_historicaltelephone', (
        ...
        db.send_create_signal(u'patient', ['HistoricalTelephone'])


    def backwards(self, orm):
        # Deleting model 'Telephone'
        db.delete_table(u'patient_telephone')

        # Deleting model 'HistoricalTelephone'
        db.delete_table(u'patient_historicaltelephone')
