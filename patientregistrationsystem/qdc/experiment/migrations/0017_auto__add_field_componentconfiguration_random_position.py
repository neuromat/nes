...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComponentConfiguration.random_position'
        db.add_column(u'experiment_componentconfiguration', 'random_position',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComponentConfiguration.random_position'
        db.delete_column(u'experiment_componentconfiguration', 'random_position')
