...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Questionnaire.used_also_outside_an_experiment'
        db.delete_column(u'experiment_questionnaire', 'used_also_outside_an_experiment')

        # Adding field 'Questionnaire.survey'
        db.add_column(u'experiment_questionnaire', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Survey'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Questionnaire.lime_survey_id'
        db.alter_column(u'experiment_questionnaire', 'lime_survey_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Adding model 'PatientQuestionnaireResponse'
        db.create_table(u'experiment_patientquestionnaireresponse', (
        ...
        db.send_create_signal(u'experiment', ['PatientQuestionnaireResponse'])

        # Adding field 'Questionnaire.used_also_outside_an_experiment'
        db.add_column(u'experiment_questionnaire', 'used_also_outside_an_experiment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Questionnaire.survey'
        db.delete_column(u'experiment_questionnaire', 'survey_id')


        # Changing field 'Questionnaire.lime_survey_id'
        db.alter_column(u'experiment_questionnaire', 'lime_survey_id', self.gf('django.db.models.fields.IntegerField')(default=0))
