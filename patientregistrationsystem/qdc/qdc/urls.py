...
urlpatterns = [
    ...
    re_path(r'^accounts/login/$', authviews.login, name='login'),
    ...
    re_path(r'^password_change/$', authviews.password_change,
    ...
    re_path(r'^password_change/done/$', authviews.password_change_done, name='password_change_done'),
    re_path(r'^user/password/reset/$', authviews.password_reset,
