...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialDemographicData.natural_of'
        db.add_column(u'patient_socialdemographicdata', 'natural_of',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocialDemographicData.citizenship'
        db.add_column(u'patient_socialdemographicdata', 'citizenship',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalSocialDemographicData.natural_of'
        db.add_column(u'patient_historicalsocialdemographicdata', 'natural_of',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalSocialDemographicData.citizenship'
        db.add_column(u'patient_historicalsocialdemographicdata', 'citizenship',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocialDemographicData.natural_of'
        db.delete_column(u'patient_socialdemographicdata', 'natural_of')

        # Deleting field 'SocialDemographicData.citizenship'
        db.delete_column(u'patient_socialdemographicdata', 'citizenship')

        # Deleting field 'HistoricalSocialDemographicData.natural_of'
        db.delete_column(u'patient_historicalsocialdemographicdata', 'natural_of')

        # Deleting field 'HistoricalSocialDemographicData.citizenship'
        db.delete_column(u'patient_historicalsocialdemographicdata', 'citizenship')
