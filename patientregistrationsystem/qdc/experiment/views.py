...
def keyword_search_ajax(request):
    ...
    return render(request, 'experiment/keyword_ajax_search.html',
...
def search_patients_ajax(request):
    ...
    if request.method == "POST":
        ...
        if request.user.has_perm('patient.sensitive_data_patient'):
            ...
            return render(request, 'experiment/ajax_search_patients.html',
            ...
            return render(request, 'experiment/ajax_search_patients_not_sensitive.html',
                                      {'patients': patient_list, 'group_id': group_id})
