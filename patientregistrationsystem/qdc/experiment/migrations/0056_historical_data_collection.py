    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_configuration_tree', models.ForeignKey(related_name='+', to='experiment.DataConfigurationTree', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('file_format', models.ForeignKey(related_name='+', to='experiment.FileFormat', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ...
                ('subject_of_group', models.ForeignKey(related_name='+', to='experiment.SubjectOfGroup', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(max_length=1, choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')])),
                ('data_configuration_tree', models.ForeignKey(related_name='+', to='experiment.DataConfigurationTree', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('eeg_cap_size', models.ForeignKey(related_name='+', to='experiment.EEGCapSize', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('eeg_setting', models.ForeignKey(related_name='+', to='experiment.EEGSetting', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('file_format', models.ForeignKey(related_name='+', to='experiment.FileFormat', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('history_user', models.ForeignKey(related_name='+', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.SET_NULL, null=True)),
                ('subject_of_group', models.ForeignKey(related_name='+', to='experiment.SubjectOfGroup', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(max_length=1, choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')])),
                ('data_configuration_tree', models.ForeignKey(related_name='+', to='experiment.DataConfigurationTree', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('emg_setting', models.ForeignKey(related_name='+', to='experiment.EMGSetting', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('file_format', models.ForeignKey(related_name='+', to='experiment.FileFormat', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
                ('history_user', models.ForeignKey(related_name='+', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.SET_NULL, null=True)),
                ('subject_of_group', models.ForeignKey(related_name='+', to='experiment.SubjectOfGroup', blank=True, on_delete=django.db.models.deletion.DO_NOTHING, null=True, db_constraint=False)),
            ],
