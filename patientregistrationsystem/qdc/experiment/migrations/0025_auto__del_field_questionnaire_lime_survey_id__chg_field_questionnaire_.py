...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Questionnaire.lime_survey_id'
        db.delete_column(u'experiment_questionnaire', 'lime_survey_id')


        # Changing field 'Questionnaire.survey'
        db.alter_column(u'experiment_questionnaire', 'survey_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['survey.Survey']))

    def backwards(self, orm):
        # Adding field 'Questionnaire.lime_survey_id'
        db.add_column(u'experiment_questionnaire', 'lime_survey_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Questionnaire.survey'
        db.alter_column(u'experiment_questionnaire', 'survey_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Survey'], null=True))
