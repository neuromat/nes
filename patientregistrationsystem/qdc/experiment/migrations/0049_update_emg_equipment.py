...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('electrodemodel_ptr', models.OneToOneField(serialize=False, to='experiment.ElectrodeModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size_unit', models.CharField(choices=[('mm', 'millimeter(s)'), ('cm', 'centimeter(s)')],
                                               max_length=10)),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                choices=[('surface', 'Surface'), ('intramuscular', 'Intramuscular'), ('needle', 'Needle')],
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, choices=[('mm', 'millimeter(s)'), ('cm', 'centimeter(s)')],
