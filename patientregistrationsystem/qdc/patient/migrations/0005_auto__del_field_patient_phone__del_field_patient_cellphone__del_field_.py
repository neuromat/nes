...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'patient_patient', 'phone')

        # Deleting field 'Patient.cellphone'
        db.delete_column(u'patient_patient', 'cellphone')

        # Deleting field 'HistoricalPatient.phone'
        db.delete_column(u'patient_historicalpatient', 'phone')

        # Deleting field 'HistoricalPatient.cellphone'
        db.delete_column(u'patient_historicalpatient', 'cellphone')


    def backwards(self, orm):
        # Adding field 'Patient.phone'
        db.add_column(u'patient_patient', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Patient.cellphone'
        db.add_column(u'patient_patient', 'cellphone',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalPatient.phone'
        db.add_column(u'patient_historicalpatient', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalPatient.cellphone'
        db.add_column(u'patient_historicalpatient', 'cellphone',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)
