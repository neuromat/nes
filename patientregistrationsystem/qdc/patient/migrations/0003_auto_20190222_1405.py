...
def make_social_class_empty_if_it_is_null(apps, schema_editor):
    ...
    historical_social_demographic_model = apps.get_model('patient', 'historicalsocialdemographicdata')
    ...
    for historical_social_demographic in historical_social_demographic_model.objects.all():
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(make_social_class_empty_if_it_is_null, make_social_class_null_if_it_is_empty),
    ]
