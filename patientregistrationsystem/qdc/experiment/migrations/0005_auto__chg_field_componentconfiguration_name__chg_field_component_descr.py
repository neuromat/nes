...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComponentConfiguration.name'
        db.alter_column(u'experiment_componentconfiguration', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        ...
        # Changing field 'Instruction.text'
        db.alter_column(u'experiment_instruction', 'text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ComponentConfiguration.name'
        db.alter_column(u'experiment_componentconfiguration', 'name', self.gf('django.db.models.fields.CharField')(default='Name of the use of the component', max_length=50))

        # Changing field 'Component.description'
        db.alter_column(u'experiment_component', 'description', self.gf('django.db.models.fields.CharField')(default='Description of the component', max_length=150))

        # Changing field 'Instruction.text'
        db.alter_column(u'experiment_instruction', 'text', self.gf('django.db.models.fields.CharField')(max_length=150))
