...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.research_project'
        db.add_column(u'experiment_experiment', 'research_project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.ResearchProject'], null=True),
                      keep_default=False)

        # Adding field 'HistoricalExperiment.research_project_id'
        db.add_column(u'experiment_historicalexperiment', 'research_project_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.research_project'
        db.delete_column(u'experiment_experiment', 'research_project_id')

        # Deleting field 'HistoricalExperiment.research_project_id'
        db.delete_column(u'experiment_historicalexperiment', 'research_project_id')
    ...
    models = {
        ...
        u'experiment.experiment': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'research_project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['experiment.ResearchProject']", 'null': 'True'}),
