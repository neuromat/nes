...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.research_project'
        db.alter_column(u'experiment_experiment', 'research_project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['experiment.ResearchProject']))

    def backwards(self, orm):

        # Changing field 'Experiment.research_project'
        db.alter_column(u'experiment_experiment', 'research_project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiment.ResearchProject'], null=True))
