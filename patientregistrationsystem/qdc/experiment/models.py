...
class Experiment(models.Model):
    ...
    research_project = models.ForeignKey(
        ResearchProject, null=False, blank=False, on_delete=models.CASCADE
    )
...
class ExperimentResearcher(models.Model):
    experiment = models.ForeignKey(Experiment, related_name='researchers', on_delete=models.CASCADE)
...
class Equipment(models.Model):
    ...
    manufacturer = models.ForeignKey(Manufacturer, related_name="set_of_equipment", on_delete=models.CASCADE)
...
class Amplifier(Equipment):
    ...
    amplifier_detection_type = models.ForeignKey(AmplifierDetectionType, null=True, blank=True, on_delete=models.CASCADE)
    tethering_system = models.ForeignKey(TetheringSystem, null=True, blank=True, on_delete=models.CASCADE)


class EEGSolution(models.Model):
    name = models.CharField(max_length=150)
    components = models.TextField(null=True, blank=True)
    manufacturer = models.ForeignKey(Manufacturer, null=False, related_name="set_of_solution", on_delete=models.CASCADE)
...
class ElectrodeModel(models.Model):
    ...
    electrode_configuration = models.ForeignKey(ElectrodeConfiguration, null=True, blank=True, on_delete=models.CASCADE)
...
class IntramuscularElectrode(ElectrodeModel):
    ...
    insulation_material = models.ForeignKey(Material, null=True, blank=True, on_delete=models.CASCADE)
...
class EEGElectrodePosition(models.Model):
    eeg_electrode_localization_system = models.ForeignKey(
        EEGElectrodeLocalizationSystem, related_name="electrode_positions", on_delete=models.CASCADE)
    name = models.CharField(max_length=150)
    ...
    position_reference = models.ForeignKey('self', null=True, blank=True, related_name='children', on_delete=models.CASCADE)
...
class EEGElectrodeNetSystem(models.Model):
    eeg_electrode_net = models.ForeignKey(EEGElectrodeNet, related_name="set_of_electrode_net_system", on_delete=models.CASCADE)
    eeg_electrode_localization_system = models.ForeignKey(
        EEGElectrodeLocalizationSystem, related_name='set_of_electrode_net_system', on_delete=models.CASCADE)
...
class EEGSetting(models.Model):
    ...
    name = models.CharField(max_length=150)
    description = models.TextField()
    copied_from = models.ForeignKey('self', null=True, related_name='children', on_delete=models.CASCADE)
...
class EEGElectrodePositionSetting(models.Model):
    eeg_electrode_layout_setting = models.ForeignKey(EEGElectrodeLayoutSetting, related_name='positions_setting', on_delete=models.CASCADE)
...
class EMGElectrodePlacement(models.Model):
    ...
    standardization_system = models.ForeignKey(StandardizationSystem, related_name='electrode_placements', on_delete=models.CASCADE)
    muscle_subdivision = models.ForeignKey(MuscleSubdivision, on_delete=models.CASCADE)
    placement_reference = models.ForeignKey('self', null=True, blank=True, related_name='children', on_delete=models.CASCADE)
...
class EMGElectrodeSetting(models.Model):
    emg_setting = models.ForeignKey(EMGSetting, related_name='emg_electrode_settings', on_delete=models.CASCADE)
...
class EMGElectrodePlacementSetting(models.Model):
    ...
    muscle_side = models.ForeignKey(MuscleSide, null=True, blank=True, on_delete=models.CASCADE)
...
class Component(models.Model):
    ...
    experiment = models.ForeignKey(Experiment, related_name='components', on_delete=models.CASCADE)
...
class ComponentAdditionalFile(models.Model):
    component = models.ForeignKey(Component, related_name="component_additional_files", on_delete=models.CASCADE)
...
class Stimulus(Component):
    stimulus_type = models.ForeignKey(StimulusType, null=False, blank=False, on_delete=models.CASCADE)
...
class GenericDataCollection(Component):
    information_type = models.ForeignKey(InformationType, null=False, blank=False, on_delete=models.CASCADE)
...
class ComponentConfiguration(models.Model):
    ...
    component = models.ForeignKey(Component, null=False, related_name="configuration", on_delete=models.CASCADE)
    # TODO Change to not null.
    parent = models.ForeignKey(Block, null=True, related_name='children', on_delete=models.CASCADE)
...
class Group(models.Model):
    experiment = models.ForeignKey(
        Experiment, null=False, blank=False, related_name='groups', on_delete=models.CASCADE)
...
class SubjectStepData(models.Model):
    ...
    data_configuration_tree = models.ForeignKey(DataConfigurationTree, null=True, blank=True, on_delete=models.CASCADE)
...
class DataFile(models.Model):
    description = models.TextField(null=False, blank=False)
    file_format = models.ForeignKey(FileFormat, null=False, blank=False, on_delete=models.CASCADE)
...
class EEGData(DataFile, DataCollection):
    ...
    eeg_cap_size = models.ForeignKey(EEGCapSize, null=True, blank=True, on_delete=models.CASCADE)
...
class TMSData(DataCollection):
    ...
    coil_orientation = models.ForeignKey(CoilOrientation, null=True, blank=True, on_delete=models.CASCADE)
    coil_orientation_angle = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(0)])
    direction_of_induced_current = models.ForeignKey(DirectionOfTheInducedCurrent, null=True, blank=True, on_delete=models.CASCADE)
    description = models.TextField(null=False, blank=False)
...
class EEGFile(models.Model):
    eeg_data = models.ForeignKey(EEGData, related_name='eeg_files', on_delete=models.CASCADE)
    file = models.FileField(upload_to=get_data_file_dir)


class EMGFile(models.Model):
    emg_data = models.ForeignKey(EMGData, related_name='emg_files', on_delete=models.CASCADE)
    file = models.FileField(upload_to=get_data_file_dir)


class AdditionalDataFile(models.Model):
    additional_data = models.ForeignKey(AdditionalData, related_name='additional_data_files', on_delete=models.CASCADE)
    file = models.FileField(upload_to=get_data_file_dir)


class DigitalGamePhaseFile(models.Model):
    digital_game_phase_data = models.ForeignKey(DigitalGamePhaseData, related_name='digital_game_phase_files', on_delete=models.CASCADE)
    file = models.FileField(upload_to=get_data_file_dir)


class GenericDataCollectionFile(models.Model):
    generic_data_collection_data = models.ForeignKey(
        GenericDataCollectionData, related_name='generic_data_collection_files', on_delete=models.CASCADE)
    file = models.FileField(upload_to=get_data_file_dir)


class EEGElectrodePositionCollectionStatus(models.Model):
    eeg_data = models.ForeignKey(EEGData, related_name='electrode_positions', on_delete=models.CASCADE)
...
class ScheduleOfSending(models.Model):
    ...
    experiment = models.ForeignKey(
        Experiment, related_name='schedule_of_sending', on_delete=models.CASCADE)
...
class PortalSelectedQuestion(models.Model):
    experiment = models.ForeignKey(Experiment, related_name='portal_selected_questions', on_delete=models.CASCADE)
