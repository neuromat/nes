...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HistoricalQuestionnaireConfiguration.group_id'
        db.add_column(u'experiment_historicalquestionnaireconfiguration', 'group_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Subject.patient'
        db.alter_column(u'experiment_subject', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.Patient']))

        # Adding field 'QuestionnaireConfiguration.group'
        db.add_column(u'experiment_questionnaireconfiguration', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['experiment.Group'], on_delete=models.PROTECT),
                      keep_default=False)
        ...
        # Adding field 'HistoricalQuestionnaireResponse.subject_of_group_id'
        db.add_column(u'experiment_historicalquestionnaireresponse', 'subject_of_group_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionnaireResponse.subject_of_group'
        db.add_column(u'experiment_questionnaireresponse', 'subject_of_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['experiment.SubjectOfGroup']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HistoricalQuestionnaireConfiguration.group_id'
        db.delete_column(u'experiment_historicalquestionnaireconfiguration', 'group_id')

        # Changing field 'Subject.patient'
        db.alter_column(u'experiment_subject', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.Patient']))

        # Deleting field 'QuestionnaireConfiguration.group'
        db.delete_column(u'experiment_questionnaireconfiguration', 'group_id')

        # Deleting field 'HistoricalQuestionnaireResponse.subject_of_group_id'
        db.delete_column(u'experiment_historicalquestionnaireresponse', 'subject_of_group_id')

        # Deleting field 'QuestionnaireResponse.subject_of_group'
