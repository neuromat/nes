...
def get_permission_list_and_senior_research_group(apps, researcher_group_name):
    ...
    permission_data, created = Permission.objects.get_or_create(codename='sensitive_data_patient',
                                                                name="Can view sensitive patient data",
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('patient', '0013_auto_20160621_2100'),
    ]
