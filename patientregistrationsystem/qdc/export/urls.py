...
urlpatterns = [
    ...
    url(r'^filter_participants/$', views.filter_participants,
        name='filter_participants'),
    url(r'^experiment_selection/$', views.experiment_selection,
    ...
    url(r'^get_experiments_by_study/(?P<study_id>\d+)/$',
        views.select_experiments_by_study),
    url(r'^get_groups_by_experiment/(?P<experiment_id>\d+)/$',
        views.select_groups_by_experiment),
]
