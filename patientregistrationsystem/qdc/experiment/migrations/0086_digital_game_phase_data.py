    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_configuration_tree', models.ForeignKey(null=True, blank=True, to='experiment.DataConfigurationTree')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_configuration_tree', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, related_name='+', blank=True, to='experiment.DataConfigurationTree')),
                ('file_format', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, related_name='+', blank=True, to='experiment.FileFormat')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('subject_of_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, db_constraint=False, related_name='+', blank=True, to='experiment.SubjectOfGroup')),
            ],
            options={
